...
SetPrivateProfileString('Graphics','renderer','Intel(R) HD Graphics 5500')
SetPrivateProfileString('Graphics','version','OpenGL version 4.4.0 - Build 20.19.15.4642 - build XXXX')
...
SetPrivateProfileString('Game Options','Last Save SOA','000000061-Forge')
...
SetPrivateProfileString('Game Options','Message Box Top','90')
...
SetPrivateProfileString('Game Options','Mouse Scroll Speed','70')
SetPrivateProfileString('Game Options','Auto Pause State','1152')
...
SetPrivateProfileString('Program Options','Tooltips','35')
